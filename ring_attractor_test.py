...
r_in[:, int(n_e/2) - 3] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.02 * 0.5)
r_in[:, int(n_e/2) - 2] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.03 * 0.5)
r_in[:, int(n_e/2) - 1] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.01 * 0.5)
r_in[:, int(n_e/2)] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.01)
r_in[:, int(n_e/2) + 1] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.01 * 0.5)
r_in[:, int(n_e/2) + 2] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.03 * 0.5)
r_in[:, int(n_e/2) + 3] = generate_gaussian_pulse(t, 5e-3, 5e-3, w=0.02 * 0.5)
